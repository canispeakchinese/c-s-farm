...
#include "../farm_Client/farm/basescene.h"
...
const QMetaObject BaseScene::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_BaseScene.data,
      qt_meta_data_BaseScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BaseScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BaseScene.stringdata0))
        return static_cast<void*>(const_cast< BaseScene*>(this));
